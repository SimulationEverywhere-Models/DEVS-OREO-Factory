...
struct mainIN : public cadmium::in_port<string>{};
struct rmIN : public cadmium::in_port<string>{};
struct rmDone : public cadmium::in_port<string>{};
...
struct mainOUT : public cadmium::out_port<int>{};
struct mainDone : public cadmium::out_port<string>{};
struct rmOUT : public cadmium::out_port<int>{};
...
int main(){
    ...
    const char * i_input_data_control = "../input_data/maintop_input_test.txt";
    ...
    /******   1Queue model instantiation *******************/
    shared_ptr<dynamic::modeling::model> queue1 = dynamic::translate::make_dynamic_atomic_model<Queue, TIME>("queue1");
    /******   2Process model instantiation *******************/
    shared_ptr<dynamic::modeling::model> process1 = dynamic::translate::make_dynamic_atomic_model< Process, TIME>("process1");
    /******   3mcheck model instantiation *******************/
    shared_ptr<dynamic::modeling::model> mcheck1 = dynamic::translate::make_dynamic_atomic_model<mCheck, TIME>("mcheck1");
    /******  4 classification model instantiation *******************/
    shared_ptr<dynamic::modeling::model> classify1 = dynamic::translate::make_dynamic_atomic_model< Classify, TIME>("classify1");
    /******  5 Formation model instantiation *******************/
    shared_ptr<dynamic::modeling::model> formation1 = dynamic::translate::make_dynamic_atomic_model< Formation, TIME>("formation1");
    /****** 6Bake atomic model instantiation *******************/
    shared_ptr<dynamic::modeling::model> bake1 = dynamic::translate::make_dynamic_atomic_model<Bake, TIME>("bake1");
    /****** 7Brokencheck atomic model instantiation *******************/
    shared_ptr<dynamic::modeling::model> brokencheck1 = dynamic::translate::make_dynamic_atomic_model<BrokenCheck, TIME>("brokencheck1");
    /****** 8Workshop atomic models instantiation *******************/
    shared_ptr<dynamic::modeling::model> workshop1 = dynamic::translate::make_dynamic_atomic_model<Workshop, TIME>("workshop1");
    /*****9 package atomic models instantiation ******************/
    shared_ptr<dynamic::modeling::model> package1 = dynamic::translate::make_dynamic_atomic_model<Package, TIME>("package1");


    /*******RawMaterial Coulped MODEL********/
    dynamic::modeling::Ports iports_RawM = {typeid(rmIN),typeid(rmDone)};
    dynamic::modeling::Ports oports_RawM = {typeid(rmOUT)};
    dynamic::modeling::Models submodels_RawM = {queue1, process1};
    dynamic::modeling::EICs eics_RawM = { dynamic::translate::make_EIC<rmIN, Queue_defs::qIn>("queue1"),
        dynamic::translate::make_EIC<rmDone,Queue_defs::qDone>("queue1")};
    dynamic::modeling::EOCs eocs_RawM = {
        dynamic::translate::make_EOC< Process_defs::pOUT,rmOUT>("process1")};
    dynamic::modeling::ICs ics_RawM = {
        dynamic::translate::make_IC<Queue_defs::qOut,Process_defs::pIN>("queue1","process1")
      
    };
    shared_ptr<dynamic::modeling::coupled<TIME>> RawM;
    RawM = make_shared<dynamic::modeling::coupled<TIME>>(
        "RawM", submodels_RawM, iports_RawM, oports_RawM, eics_RawM, eocs_RawM, ics_RawM
    );
    ...
    /*******main Coulped MODEL********/
    dynamic::modeling::Ports iports_maino = {typeid(mainIN)};
    dynamic::modeling::Ports oports_maino = {typeid(mainOUT)};
    dynamic::modeling::Models submodels_maino = {RawM,Mfc,package1};
    dynamic::modeling::EICs eics_maino = { dynamic::translate::make_EIC<mainIN, rmIN>("RawM")};
    dynamic::modeling::EOCs eocs_maino = {
        dynamic::translate::make_EOC< Package_defs::out,mainOUT>("package1")};
    dynamic::modeling::ICs ics_maino = {
        dynamic::translate::make_IC<rmOUT,materialsIN>("RawM","Mfc"),
        dynamic::translate::make_IC<oreo,Package_defs::in>("Mfc","package1"),
        dynamic::translate::make_IC<Package_defs::done,rmDone>("package1","RawM")
        
      
    };
    shared_ptr<dynamic::modeling::coupled<TIME>> maino;
    maino = make_shared<dynamic::modeling::coupled<TIME>>(
        "maino", submodels_maino, iports_maino, oports_maino, eics_maino, eocs_maino, ics_maino
    );
    
    
    /*******TOP Coulped MODEL********/
    dynamic::modeling::Ports iports_TOP = {};
    dynamic::modeling::Ports oports_TOP = {typeid(mainOUT)};
    dynamic::modeling::Models submodels_TOP = {input_reader_con, maino};
    dynamic::modeling::EICs eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP = {
        dynamic::translate::make_EOC< mainOUT,mainOUT>("maino")
    };
    dynamic::modeling::ICs ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<string>::out,mainIN>("input_reader_con","maino"),
