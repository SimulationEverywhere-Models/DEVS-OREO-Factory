...
int main(){
    ...
    const char * i_input_data_control = "../input_data/formation_input_test.txt";
    ...
    dynamic::modeling::Ports oports_TOP = {typeid(fOUT)};
    dynamic::modeling::Models submodels_TOP = {input_reader_con, formation1};
    dynamic::modeling::EICs eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP = {
        dynamic::translate::make_EOC< Formation_defs::fOUT,fOUT>("formation1")};
    dynamic::modeling::ICs ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<int>::out,Formation_defs::fIN>("input_reader_con","formation1"),
    ...
    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/formation_test_output_messages.txt");
    ...
    static ofstream out_state("../simulation_results/formation_test_output_state.txt");
