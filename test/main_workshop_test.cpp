...
int main(){
    ...
    const char * i_input_data_control = "../input_data/workshop_cream_input_test.txt";
    ...
    const char * i_input_data_control2 = "../input_data/workshop_biscuit_input_test.txt";
    ...
    dynamic::modeling::Models submodels_TOP = {input_reader,input_reader2, workshop1};
    dynamic::modeling::EICs eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP = {
        dynamic::translate::make_EOC<Workshop_defs::out,outp>("workshop1"),
    };
    dynamic::modeling::ICs ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<int>::out,Workshop_defs::CreamIn>("input_reader","workshop1"),
        dynamic::translate::make_IC<iestream_input_defs<int>::out,Workshop_defs::BiscuitIn>("input_reader2","workshop1")
    };
    ...
    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/workshop_test_output_messages.txt");
    struct oss_sink_messages{
        static ostream& sink(){          
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/workshop_test_output_state.txt");
