...
struct mIN : public cadmium::in_port<int>{};
...
int main(){
    ...
    const char * i_input_data_control = "..input_data/classify_input_test.txt";
    ...
    dynamic::modeling::Models submodels_TOP = {input_reader_con, classify1};
    dynamic::modeling::EICs eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP = {
        dynamic::translate::make_EOC< Classify_defs::Biscuits,Biscuits>("classify1"),
        dynamic::translate::make_EOC< Classify_defs::Cream,Cream>("classify1")
    };
    dynamic::modeling::ICs ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<int>::out,Classify_defs::mIN>("input_reader_con","classify1"),
    ...
    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/classify_test_output_messages.txt");
    ...
    static ofstream out_state("../simulation_results/classify_test_output_state.txt");
